...
class TestNMConnectionListener(unittest.TestCase) :
    ...
    def test_addingCallback(self):
        ...
        self.nmListener.add_callback(callback)
        self.nmListener._run_callbacks()
    ...
    def test_callbackArgs(self):
        ...
        """
        callback = LogingCallback()
        self.nmListener.add_callback(callback, 'foo', 'bar')
        self.nmListener._run_callbacks()
    ...
    def test_callbackArgsAndKWargs(self):
        ...
        """
        callback = LogingCallback()
        self.nmListener.add_callback(callback, 'empathy', foo='bar')
        self.nmListener._run_callbacks()
    ...
    def test_multipleCallbacks(self):
        ...
        cb1 = LogingCallback()
        cb2 = LogingCallback()
        self.nmListener.add_callback(cb1, 'cb1 called')
        self.nmListener.add_callback(cb2, 'cb2 called')
        self.nmListener._run_callbacks()
    ...
    def test_registerCallbackMultipleTimes(self):
        ...
        """
        callback = LogingCallback()
        self.nmListener.add_callback(callback, 'foo')
        self.nmListener.add_callback(callback, 'bar')
        self.nmListener._run_callbacks()
